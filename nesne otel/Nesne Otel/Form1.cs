...
namespace Nesne_Otel
{
    public partial class Form1 : Form
    {
      ...
      public static  DataSet ds = new DataSet();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            if (rboda.Checked == true)
            {
                ...
                if (c == DialogResult.Yes)
                {
                    ...
                    string urunadim = dataGridView1.CurrentRow.Cells["urunadi"].Value.ToString();
                    OleDbCommand cmd = new OleDbCommand();
                    cmd.Connection = baglanti;
                    cmd.CommandText = "delete from oda  where urunadi=@urunadi";
                    cmd.Parameters.AddWithValue("@urunadi", urunadim);
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Kayıt Silindi!");    //BEN BURADA DA DATAGRİDWİEWİN ÜZERİNE GELEREK SİLİYORUM..  
                    urunadi.Text=""; adet.Clear(); fiyat.Clear(); firma.Clear(); kategori.Text = ""; firma.Clear(); gelistarihi.Value.ToString("");
                    bs.Position = tutindex;
                    veri_oda();
                }
            }
        ...
        private void aranan_TextChanged(object sender, EventArgs e)
        {
            if (rbmutfak.Checked == true)
            {
                ...
                else
                {
                    ...
                    {
                        if (baglanti.State == ConnectionState.Closed) baglanti.Open();
                        //OleDbDataAdapter da = new OleDbDataAdapter("Select * from mutfak where urunadi LIKE '%" + aranan.Text + "%'", baglanti);
                        //DataSet ds = new DataSet();
                        //da.Fill(ds, "mutfak");
                        //bs.DataSource = ds.Tables["mutfak"];
                        //dataGridView1.DataSource = bs;
                        string sec = "select*from mutfak where urunadi like'%" + aranan.Text + "%'";
                    ...
                    {
                        if (baglanti.State == ConnectionState.Closed) baglanti.Open();
                        //OleDbDataAdapter da = new OleDbDataAdapter("SElect * from mutfak where kategori LIKE '%" + aranan.Text + "%'", baglanti);
                        //DataSet ds = new DataSet();
                        //da.Fill(ds, "mutfak");
                        //bs.DataSource = ds.Tables["mutfak"];
                        //dataGridView1.DataSource = bs;
                        string sec = "select*from mutfak where kategori like'%" + aranan.Text + "%'";
                        //'% kısa metin olduğu için tırnağa alıyoruz yüzde isegirlenin kelimenin hangi yerinde olursa olsun verileri getirir ekrana
                        OleDbDataAdapter da = new OleDbDataAdapter(sec, baglanti);
                        ds.Clear();
                        da.Fill(ds, "mutfak");
                    ...
                    {
                        if (baglanti.State == ConnectionState.Closed) baglanti.Open();
                        //OleDbDataAdapter da = new OleDbDataAdapter("SElect * from mutfak where firma LIKE '%" + aranan.Text + "%'", baglanti);
                        //DataSet ds = new DataSet();
                        //da.Fill(ds, "mutfak");
                        //bs.DataSource = ds.Tables["mutfak"];
                        //dataGridView1.DataSource = bs;
                        string sec = "select*from mutfak where firma like'%" + aranan.Text + "%'";
                        //'% kısa metin olduğu için tırnağa alıyoruz yüzde isegirlenin kelimenin hangi yerinde olursa olsun verileri getirir ekrana
                        OleDbDataAdapter da = new OleDbDataAdapter(sec, baglanti);
                        ds.Clear();
                        da.Fill(ds, "mutfak");
            ...
            if (rboda.Checked == true)
            {
                ...
                else
                {
                    ...
                    {
                        if (baglanti.State == ConnectionState.Closed) baglanti.Open();
                        //OleDbDataAdapter da = new OleDbDataAdapter("Select * from oda where urunadi LIKE '%" + aranan.Text + "%'", baglanti);
                        //DataSet ds = new DataSet();
                        //da.Fill(ds, "oda");
                        //bs.DataSource = ds.Tables["oda"];
                        //dataGridView1.DataSource = bs;
                        string sec = "select*from oda where urunadi like'%" + aranan.Text + "%'";
                        //'% kısa metin olduğu için tırnağa alıyoruz yüzde isegirlenin kelimenin hangi yerinde olursa olsun verileri getirir ekrana
                        OleDbDataAdapter da = new OleDbDataAdapter(sec, baglanti);
                        ds.Clear();
                        da.Fill(ds, "oda");
                    ...
                    {
                        if (baglanti.State == ConnectionState.Closed) baglanti.Open();
                        //OleDbDataAdapter da = new OleDbDataAdapter("SElect * from oda where kategori LIKE '%" + aranan.Text + "%'", baglanti);
                        //DataSet ds = new DataSet();
                        //da.Fill(ds, "oda");
                        //bs.DataSource = ds.Tables["oda"];
                        //dataGridView1.DataSource = bs;
                        string sec = "select*from oda where kategori like'%" + aranan.Text + "%'";
                        //'% kısa metin olduğu için tırnağa alıyoruz yüzde isegirlenin kelimenin hangi yerinde olursa olsun verileri getirir ekrana
                        OleDbDataAdapter da = new OleDbDataAdapter(sec, baglanti);
                        ds.Clear();
                        da.Fill(ds, "oda");
                    ...
                    {
                        if (baglanti.State == ConnectionState.Closed) baglanti.Open();
                        //OleDbDataAdapter da = new OleDbDataAdapter("SElect * from oda where firma LIKE '%" + aranan.Text + "%'", baglanti);
                        //DataSet ds = new DataSet();
                        //da.Fill(ds, "oda");
                        //bs.DataSource = ds.Tables["oda"];
                        //dataGridView1.DataSource = bs;
                        string sec = "select*from oda where firma like'%" + aranan.Text + "%'";
                        //'% kısa metin olduğu için tırnağa alıyoruz yüzde isegirlenin kelimenin hangi yerinde olursa olsun verileri getirir ekrana
                        OleDbDataAdapter da = new OleDbDataAdapter(sec, baglanti);
                        ds.Clear();
                        da.Fill(ds, "oda");
        ...
        {
            murapor asd = new murapor();
            asd.Show();
        }

        private void pictureBox7_Click(object sender, EventArgs e)
        {
            odarapor azz = new odarapor();
            azz.Show();
        }
    }
}
